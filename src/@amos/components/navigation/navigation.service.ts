...
export class amosNavigationService {
    private _componentRegistry: Map<string, any> = new Map<string, any>();
    private _navigationStore: Map<string, amosNavigationItem[]> = new Map<
        string,
        any
    >();
     ...
     * @param navigation
     */
    storeNavigation(key: string, navigation: amosNavigationItem[]): void {
        // Add to the store
     ...
     * @param key
     */
    getNavigation(key: string): amosNavigationItem[] {
     ...
     */
    getFlatNavigation(
        navigation: amosNavigationItem[],
        flatNavigation: amosNavigationItem[] = []
    ): amosNavigationItem[] {
    ...
    getItemParent(
        id: string,
        navigation: amosNavigationItem[],
        parent: amosNavigationItem[] | amosNavigationItem
    ): amosNavigationItem[] | amosNavigationItem | null {
        for (const item of navigation) {
            if (item.id === id) {
                return parent;
            }
