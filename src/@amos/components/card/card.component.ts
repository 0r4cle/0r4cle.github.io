...
import { amosCardFace } from '@amos/components/card/card.types';
...
export class amosCardComponent implements OnChanges {
    ...
    @HostBinding('class') get classList(): any {
        ...
        return {
            ...
            'amos-card-face-back': this.flippable && this.face === 'back',
            'amos-card-face-front': this.flippable && this.face === 'front',
