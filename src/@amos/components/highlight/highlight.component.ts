...
import { amosHighlightService } from '@amos/components/highlight/highlight.service';

@Component({
    selector: 'textarea[amos-highlight]',
    templateUrl: './highlight.component.html',
    styleUrls: ['./highlight.component.scss'],
    encapsulation: ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush,
    exportAs: 'amosHighlight',
})
export class amosHighlightComponent implements OnChanges, AfterViewInit {
    @Input() code: string;
    @Input() lang: string;
    ...
    constructor(
        ...
        private _amosHighlightService: amosHighlightService,
    ...
    private _highlightAndInsert(): void {
        ...
        this.highlightedCode = this._domSanitizer.sanitize(
            ...
            this._amosHighlightService.highlight(this.code, this.lang)
        );
