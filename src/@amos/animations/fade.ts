...
import {
    amosAnimationCurves,
    amosAnimationDurations,
} from '@amos/animations/defaults';
...
const fadeIn = trigger('fadeIn', [
    ...
    transition('void => *', animate('{{timings}}'), {
        params: {
            timings: `${amosAnimationDurations.entering} ${amosAnimationCurves.deceleration}`,
        },
    }),
]);
...
const fadeOut = trigger('fadeOut', [
    ...
    transition('* => void', animate('{{timings}}'), {
        params: {
            timings: `${amosAnimationDurations.exiting} ${amosAnimationCurves.acceleration}`,
        },
    }),
]);
