...
import { amosMockApiReplyCallback } from '@amos/lib/mock-api/mock-api.types';

export class amosMockApiHandler {
    request!: HttpRequest<any>;
    urlParams!: { [key: string]: string };

    // Private
    private _reply: amosMockApiReplyCallback = undefined;
     ...
     * @param callback
     */
    reply(callback: amosMockApiReplyCallback): void {
        // Store the reply
