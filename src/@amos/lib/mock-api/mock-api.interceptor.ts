...
export class amosMockApiInterceptor implements HttpInterceptor {
    /**
     * Constructor
     */
    constructor(
        @Inject(amos_MOCK_API_DEFAULT_DELAY) private _defaultDelay: number,
    ...
    intercept(
        ...
        const { handler, urlParams } = this._amosMockApiService.findHandler(
