...
const config = {
    ...
    theme: {
        ...
        screens: {
            ...
            lg: "1280px",
            xl: "1440px",
            rl: { min: "1440px", max: "1777px" },
            calen: { min: "1440px", max: "1600px" },
            xxl: { min: "1777px", max: "2560px" },
        },
        extend: {
            animation: {
            ...
            backgroundImage: {
                "pattern-img": "url('  /src/assets/images/upload/pattern.png')",
                "edu-img": "url('  /src/assets/images/figures/5.svg')",
                "bpattern-img":
                    "url(' /src/assets/images/figures/image 87.svg')",
            },
            spacing: {
                13: "3.25rem",
                15: "3.75rem",
