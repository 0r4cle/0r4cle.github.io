    ...
    [709],
    {
        6709: (q, f, s) => {
            ...
            const C = ["input"],
                y = ["label"],
                M = function (a) {
                    return { enterDuration: a };
                },
                v = ["*"],
                A = new e.OlP("mat-checkbox-default-options", {
                    providedIn: "root",
                    factory: u,
                });
            function u() {
            ...
            let D = (() => {
                    class a extends R {
                        constructor(i, t, n, o, d, k, l) {
                            super(t),
                                ...
                                (this.indeterminateChange = new e.vpe()),
                                (this._onTouched = () => {}),
                                ...
                                (this._options = this._options || p),
                                (this.color = this.defaultColor =
                                    this._options.color || p.color),
                                (this.tabIndex = parseInt(d) || 0),
                                (this.id = this._uniqueId = `${i}${++T}`);
                        }
                        get inputId() {
                        ...
                        set indeterminate(i) {
                            const t = i != this._indeterminate;
                            (this._indeterminate = (0, h.Ig)(i)),
                                t &&
                        ...
                        _transitionCheckState(i) {
                            ...
                            if (
                                ...
                                (this._currentAnimationClass =
                                    this._getAnimationClassForCheckStateTransition(
                                        t,
                                        i
                                    )),
                        ...
                        _emitChangeEvent() {
                            this._controlValueAccessorChangeFn(this.checked),
                                this.change.emit(
                                    this._createChangeEvent(this.checked)
                                ),
                                this._inputElement &&
                                    (this._inputElement.nativeElement.checked =
                                        this.checked);
                        }
                        toggle() {
                        ...
                        _handleInputClick() {
                            const i = this._options?.clickAction;
                        ...
                        _getAnimationClassForCheckStateTransition(i, t) {
                        ...
                        _syncIndeterminate(i) {
                            ...
                            t && (t.nativeElement.indeterminate = i);
                        }
                    }
                    return (
                        (a.ɵfac = function (i) {
                        ...
                        (a.ɵdir = e.lG2({
                            ...
                            viewQuery: function (i, t) {
                                if (
                                    (1 & i &&
                                        (e.Gf(C, 5), e.Gf(y, 5), e.Gf(r.wG, 5)),
                                    2 & i)
                                ) {
                                    let n;
                                    e.iGM((n = e.CRH())) &&
                                        (t._inputElement = n.first),
                                        e.iGM((n = e.CRH())) &&
                                            (t._labelElement = n.first),
                                        e.iGM((n = e.CRH())) &&
                                            (t.ripple = n.first);
                                }
                            },
                ...
                _ = (() => {
                    class a extends D {
                        constructor(i, t, n, o, d, k, l) {
                            super("mat-checkbox-", i, t, o, d, k, l),
                        ...
                        _createChangeEvent(i) {
                            const t = new I();
                            return (t.source = this), (t.checked = i), t;
                        }
                        ...
                        _onInputClick(i) {
                            i.stopPropagation(), super._handleInputClick();
                        }
                        focus(i, t) {
                            i
                    ...
                    return (
                        ...
                        (a.ɵcmp = e.Xpm({
                            ...
                            hostBindings: function (i, t) {
                                2 & i &&
                                    (e.Ikx("id", t.id),
                                    e.uIk("tabindex", null)("aria-label", null)(
                                        "aria-labelledby",
                                        null
                                    ),
                                    e.ekj(
                                        ...
                                        t.indeterminate
                                    )("mat-checkbox-checked", t.checked)(
                                ...
                                if (
                                    (1 & i &&
                                        ...
                                        e.NdJ("change", function (o) {
                                            return t._onInteractionEvent(o);
                                        })("click", function (o) {
                                            return t._onInputClick(o);
                                        }),
                                        e.qZA(),
                                        e.TgZ(5, "span", 5),
                                        e._UZ(6, "span", 6),
                                        ...
                                        e.qZA()(),
                                        e.TgZ(12, "span", 12, 13),
                                        e.NdJ("cdkObserveContent", function () {
                                    ...
                                    e.uIk("for", t.inputId),
                                        ...
                                        e.uIk("value", t.value)("name", t.name)(
                                            "aria-label",
                                            t.ariaLabel || null
                ...
                w = (() => {
                    ...
                    return (
                        ...
                        (a.ɵmod = e.oAB({ type: a })),
                        (a.ɵinj = e.cJS({
                            imports: [r.si, r.BQ, b.Q8, x, r.BQ, x],
                        })),
                        a
                    );
                })();
